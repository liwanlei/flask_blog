...
------------------------------------------------
# 部署在阿里云上 http://60.205.187.178:3389
...
## 部署后运行效果，后期会做一些优化，展示的界面如下图所示。可能部分界面不太兼容，目前水平有限。
![Alt text](https://github.com/liwanlei/flask_blog-python3/blob/master/img/1.png)
![Alt text](https://github.com/liwanlei/flask_blog-python3/blob/master/img/2.png)
![Alt text](https://github.com/liwanlei/flask_blog-python3/blob/master/img/22.png)
![Alt text](https://github.com/liwanlei/flask_blog-python3/blob/master/img/222.png)
![Alt text](https://github.com/liwanlei/flask_blog-python3/blob/master/img/2222.png)
![Alt text](https://github.com/liwanlei/flask_blog-python3/blob/master/img/3.png)
# 基于阿里云服务器 Ningx+uswgi+supervisor的部署已经完成，配置文件也上传，并且可以实现部署，然后做自动化，第一个flask 自己写的东西已经完成差不多了。
